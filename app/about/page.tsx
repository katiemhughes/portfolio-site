...
export default function About() {
  return (
    <main className='about'>
        <h1 className='about__title'>About Me<span className='about__title--lilac'>.</span></h1>
        <section className='about__section'>
          ...
          <p>I had recently taken up music production as a hobby, live coding music on a program called <a className='about__link' href='https://sonic-pi.net/'>Sonic Pi</a>. So, I decided to put this skill to good use. I did some FreeCodeCamp courses and followed some YouTube tutorials on how to make websites using HTML, Javascript and CSS, and then landed a scholarship for a bootcamp. The scholarship was awarded by an organisation called <a className='about__link' href='https://digitalher.co.uk/'>Digital Her</a>, and the bootcamp was the 3-month Develop course at <a className='about__link' href='https://wearecodenation.com/'>Code Nation</a>.</p>
          <p>After completing the bootcamp, I then obtained an apprenticeship following a year long placement. I then finally landed my job at <a className='about__link' href='https://www.eclipsegroup.co.uk/'>Eclipse Group Solutions</a>, where I currently work as a Junior Optimisation Developer.</p>
